...
Use `runs/get` when replay has already happened and you need evidence. If you are still deciding whether a playbook should run, start with `playbooks/candidate` or `playbooks/dispatch`.
