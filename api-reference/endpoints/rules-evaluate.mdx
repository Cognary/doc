...
Use `rules/evaluate` when your question is “what policy would apply here?” Use `tools/select` when your question becomes “which tool should the runtime actually choose and persist?”
